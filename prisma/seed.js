...
async function geocodeAddress(address) {
    ...
    const inRostov = Number.isFinite(latitude) &&
        Number.isFinite(longitude) &&
        latitude >= 47.05 &&
        latitude <= 47.45 &&
        longitude >= 39.45 &&
...
const OBJECTS = [
    {
        ...
        description: 'Многофункциональный спортивный объект, предназначенный для проведения тренировок, соревнований и физкультурно-оздоровительных занятий. Комплекс ориентирован на подготовку спортсменов по боксу и кикбоксингу, а также проведение спортивно-массовых мероприятий.',
        address: 'г. Ростов-на-Дону, ул. Капустина, 18/1',
        district: client_1.District.VOROSHILOVSKY,
    ...
    {
        name: 'МБУ ДО «СШ № 10»',
        description: 'Многофункциональный спортивный объект, предназначенный для проведения тренировок, соревнований и физкультурно-оздоровительных занятий. Комплекс ориентирован на подготовку спортсменов и организацию занятий по плаванию, синхронному плаванию, боксу и дзюдо.',
    ...
    },
    {
        ...
        description: 'Многофункциональный спортивный объект, предназначенный для проведения тренировок, соревнований и физкультурно-оздоровительных занятий. Комплекс ориентирован на подготовку спортсменов по вольной и греко-римской борьбе, тяжёлой атлетике и художественной гимнастике.',
    ...
    },
    {
        ...
        description: 'Многофункциональный спортивный объект для лиц с ограниченными возможностями здоровья. Комплекс ориентирован на подготовку спортсменов по адаптивным видам спорта: плавание, лёгкая атлетика, настольный теннис, шахматы, шашки, спортивная гимнастика.',
    ...
    },
    {
        ...
        description: 'Многофункциональный спортивный объект, предназначенный для проведения тренировок, соревнований и физкультурно-оздоровительных занятий. Комплекс ориентирован на подготовку спортсменов по лёгкой атлетике, плаванию, футболу, теннису, тхэквондо и греко-римской борьбе.',
    ...
    },
    {
        ...
        description: 'Многофункциональный спортивный объект для подготовки спортсменов по гребному спорту, гребле на байдарках и каноэ, BMX, волейболу, теннису, футболу, триатлону, скалолазанию, шахматам и другим видам спорта.',
        address: 'г. Ростов-на-Дону, ул. Пойменная, 2а',
        district: client_1.District.KIROVSKY,
    ...
    },
    {
        ...
        description: 'Спортивный комплекс, обеспечивающий проведение учебно-тренировочного процесса, соревнований и массовых спортивных мероприятий. На базе объекта развиваются футбол, бейсбол, лёгкая атлетика, баскетбол, волейбол и гандбол.',
        address: 'г. Ростов-на-Дону, ул. Пойменная, 2а',
        district: client_1.District.KIROVSKY,
    ...
    {
        name: 'МБУ ДО СШ № 4',
        description: 'Спортивный объект, предназначенный для проведения тренировочных занятий, соревнований и физкультурно-оздоровительных мероприятий. На базе школы развиваются футбол, велоспорт, плавание и шахматы.',
        address: 'г. Ростов-на-Дону, ул. Тельмана, 14а',
        district: client_1.District.OKTYABRSKY,
        phone: '8 (863) 282-83-64',
    ...
    },
    {
        ...
        description: 'Спортивный объект для подготовки спортсменов по тхэквондо, фехтованию, художественной гимнастике, бильярдному спорту и акробатическому рок-н-роллу.',
    ...
    {
        name: 'МБУ ДО «СШОР № 2»',
        description: 'Спортивный объект, специализирующийся на подготовке спортсменов по спортивной гимнастике и проведении учебно-тренировочных занятий.',
        address: 'г. Ростов-на-Дону, пер. Беломорский, 16б',
        district: client_1.District.PERVOMAYSKY,
    ...
    {
        name: 'МБУ ДО «СШ «13»»',
        description: 'Спортивный объект для проведения учебно-тренировочных занятий и соревнований. Развиваются плавание, кудо, гандбол, тхэквондо, футбол, теннис, самбо, волейбол, спортивная акробатика, спортивная борьба и настольный теннис.',
    ...
    {
        name: 'МБУ ДО «СШ № 3»',
        description: 'Центр спортивной подготовки, ориентированный на развитие игровых и индивидуальных видов спорта: бадминтон, настольный теннис, теннис и чир спорт.',
    ...
    {
        name: 'МБУ ДО «СШ № 6»',
        description: 'Спортивная школа, специализирующаяся на игровых видах спорта и подготовке спортсменов. Проводятся тренировки по волейболу, футболу, баскетболу, тхэквондо, дзюдо, кудо, художественной гимнастике.',
    ...
    },
    {
        ...
        description: 'Спортивная школа, специализирующаяся на подготовке спортсменов в видах единоборств: бокс, дзюдо, самбо, вольная и греко-римская борьба. Также развиваются гандбол, гребной спорт, лёгкая атлетика, парусный спорт, скалолазание, теннис, футбол.',
    ...
    },
    {
        ...
        description: 'Центр олимпийской подготовки. Развиваются бокс, велоспорт, гребной спорт, гребля на байдарках и каноэ, дзюдо, лёгкая атлетика, парусный спорт, прыжки на батуте, современное пятиборье, спортивная борьба, стрельба из лука, тхэквондо, тяжёлая атлетика, фехтование, художественная гимнастика.',
    ...
    },
    {
        ...
        description: 'Спортивный объект с бассейном. Развиваются водное поло, конный спорт, плавание, синхронное плавание, современное пятиборье и фехтование.',
    ...
    {
        name: 'МБУ ДО «СШ № 11»',
        description: 'Спортивная школа с широким профилем единоборств и гимнастики. Развиваются кудо, дзюдо, тхэквондо, киокусинкай, чир спорт, акробатический рок-н-ролл, спортивная борьба, прыжки в воду, брейкинг.',
    ...
    {
        name: 'МБУ ДО «СШ № 1»',
        description: 'Спортивная школа с разнообразной инфраструктурой. Развиваются лёгкая атлетика, пулевая стрельба, дартс и баскетбол.',
        address: 'г. Ростов-на-Дону, пр. 40-летия Победы, 63/14',
        district: client_1.District.PROLETARSKY,
    ...
    {
        name: 'МБУ ДО «СШ № 7»',
        description: 'Спортивная школа, специализирующаяся на баскетболе и спортивной борьбе.',
    ...
    {
        name: 'МБУ ДО «СШ № 12»',
        description: 'Спортивный объект с разнообразной инфраструктурой. Развиваются футбол, настольный теннис, акробатический рок-н-ролл, художественная гимнастика, лёгкая атлетика, волейбол.',
        address: 'г. Ростов-на-Дону, ул. 2-я Краснодарская, 149В',
        district: client_1.District.SOVETSKY,
    ...
    },
    {
        ...
        description: 'Спортивная школа олимпийского резерва, специализирующаяся на зимних видах спорта: фигурное катание на коньках и хоккей.',
    ...
    {
        name: 'МБУ ДО «СШ № 5»',
        description: 'Спортивная школа с широким профилем. Развиваются волейбол, гандбол, художественная гимнастика, каратэ, борьба на поясах.',
        address: 'г. Ростов-на-Дону, ул. Загорская, 10',
        district: client_1.District.ZHELEZNODOROZHNY,
    ...
    },
    {
        ...
        description: 'Спортивная школа олимпийского резерва. Развиваются бокс, велоспорт (ВМХ, МТБ, трек, шоссе), пулевая стрельба, стендовая стрельба, стрельба из лука, теннис, футбол.',
    ...
    {
        name: 'МБУ ДО «СШ № 8»',
        description: 'Спортивная школа с уклоном в единоборства: спортивная борьба (греко-римская и вольная), бокс, самбо, дзюдо.',
    ...
    {
        name: 'ГБПОУ РО «РОУОР»',
        description: 'Многопрофильный спортивный объект. Развиваются баскетбол, бокс, водное поло, велоспорт, гандбол, гребной спорт, лёгкая атлетика, парусный спорт, плавание, синхронное плавание, самбо, современное пятиборье, спортивная борьба, спортивная гимнастика, художественная гимнастика, триатлон, фехтование, футбол.',
    ...
    for (const obj of OBJECTS) {
        ...
        const result = await prisma.sportObject.create({
            data: {
                ...
                status: client_1.SportObjectStatus.PUBLISHED,
